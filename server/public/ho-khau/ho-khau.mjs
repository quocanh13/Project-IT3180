...
function renderRow(hoKhauFull) {
    ...
    row.innerHTML = `
        ...
        <td style="text-align: center;">
            <button class="btn-action btn-action-edit" onclick="editHoKhau('${hoKhauFull._id}')" title="Sửa">
            ...
            <button class="btn-action btn-action-delete" onclick="removeHoKhau('${hoKhauFull._id}')" title="Xóa">
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
